document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      if (sibling && sibling.classList && sibling.classList.contains('form-error-message')) {
        sibling.remove();
      }
    }
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if (field.maxLength && field.maxLength > 0 && value.length > field.maxLength) {
          showError(field, label + ' must be no more than ' + field.maxLength + ' characters.');
          return false;
        }
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '22bc7f85-76d4-45d9-b0b0-1a1cf446f128',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '22bc7f85-76d4-45d9-b0b0-1a1cf446f128';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '22bc7f85-76d4-45d9-b0b0-1a1cf446f128';
